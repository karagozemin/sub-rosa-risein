...
import { sha256Commitment } from "./risein-contract";
import { isValidRecipient, validateAmount } from "./risein-stellar";

describe("Rise In XLM validation", () => {
...
describe("Rise In commitment hashing", () => {
